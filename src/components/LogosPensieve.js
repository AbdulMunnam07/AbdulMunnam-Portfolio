    ...
    <div>
      ...
      >
        <div className="w-[2.5rem] flex flex-col justify-between items-center pt-[10px]">
          ...
          >
            <a
              href="https://github.com/AbdulMunnam07"
              target="_blank"
              aria-label="GitHub"
            >
              <svg
          ...
          >
            <a
              href="https://leetcode.com/u/AbdulMunnam/"
              aria-label="Leetcode"
              target="_blank"
            >
              {/* <svg
          ...
          >
            <a
              href="https://www.linkedin.com/in/munnammalik?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
              aria-label="Linkedin"
              target="_blank"
            >
              <svg
      ...
      >
        ...
        >
          <a
            ...
            href="mailto:amunnam07@gmail.com"
          >
            amunnam07@gmail.com
          </a>
          {/* Straight Line */}
