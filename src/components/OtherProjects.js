      ...
      <div className={`flex flex-wrap gap-[15px] cursor-default`}>
        ...
        >
          ...
          <div className="w-[100%] h-10 bg-[#172a45] flex justify-between items-center">
            ...
            >
              <a
                href="https://github.com/AbdulMunnam07/React_Project/tree/main/01%20-%20Password%20Generator"
          ...
          Password Generator: Create secure, customizable passwords in seconds. Choose your length, add symbols, numbers, and enjoy peace of mind with unique, strong passwords every time!
          </div>
          {/* Footer */}
        ...
        >
          ...
          Hacker Terminal: A fun, high-tech simulation that lets you feel like a hacker—trick your friends or enjoy the thrill yourself!
          </div>
          {/* Footer */}
        ...
        >
          ...
          <div className="w-[100%] h-10 bg-[#172a45] flex justify-between items-center">
            ...
            >
              <a
                href="https://github.com/AbdulMunnam07/SMIT_Projects/tree/main/2.%20E%20Commerce%20Website%20using%20APis"
                aria-label="GitHub Link"
                target="_blank"
              >
                <svg
          ...
          A streamlined shopping experience using the Fake Store API to fetch product data, with easy browsing, a responsive interface, and a smooth checkout simulation for practice and learning!
          </div>
          {/* Footer */}
        ...
        >
          ...
          <div className="w-[100%] h-10 bg-[#172a45] flex justify-between items-center">
            ...
            >
              <a
                href="https://github.com/AbdulMunnam07/SMIT_Projects/tree/main/1.%20Scientific%20Calculator"
                aria-label="GitHub Link"
                target="_blank"
              >
                <svg
          ...
          Advanced functions for complex calculations—ideal for students and professionals needing precise results!
          </div>
          {/* Footer */}
        ...
        >
          ...
          <div className="w-[100%] h-10 bg-[#172a45] flex justify-between items-center">
            ...
            >
              <a
                href="https://github.com/AbdulMunnam07/SMIT-Assignments/tree/main/Restaurants%20Website"
                aria-label="GitHub Link"
                target="_blank"
              >
                <svg
          ...
          <div className="h-[40%] mt-[10px] bg-[#172a45] antialiased text-[17px] text-[#a8b2d1] font-calibri leading-[1.3] opScreen6:h-[30%] opScreen7:h-[35%] opScreen13:h-[30%] opScreen16:mt-[20px] opScreen17:h-[38%] opScreen25:h-[35%] opScreen29:h-[25%] opScreen30:h-[37%]">
            Front of restourant app best for sharping your skills!
          </div>
          {/* Footer */}
        ...
        >
          ...
          <div className="w-[100%] h-10 bg-[#172a45] flex justify-between items-center">
            ...
            >
              <a
                href="https://github.com/AbdulMunnam07/YouTube-Assignments/tree/main/Dynamic%20Website%20Builder"
                aria-label="GitHub Link"
                target="_blank"
              >
                <svg
          ...
          A user-friendly tool for creating interactive, responsive websites with customizable layouts and features—no backend required!
          </div>
          {/* Footer */}
          ...
          <>
            ...
            >
              ...
              <div className="h-[40%] mt-[10px] bg-[#172a45] antialiased text-[17px] text-[#a8b2d1] font-calibri leading-[1.3] opScreen5:h-[45%] opScreen6:h-[40%] opScreen7:h-[35%] opScreen13:h-[30%] opScreen16:mt-[30px] opScreen17:h-[44%] opScreen20:h-[50%] ">
                Calculator to find factorial easily by clicking some buttons.
              </div>
              {/* Footer */}
